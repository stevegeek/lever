...
- **In progress:** broker-fronted external MCP servers (host tools capability-gated through the mTLS gateway — replaces per-port egress holes; instance migration pending); per-step bring-up progress; load a grove image at apply time;
